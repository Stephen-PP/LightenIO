...
export default function EmptyUploader() {
    return (
        <div className="flex justify-center">
            <div className="flex justify-center mt-20 w-full max-w-screen-2xl h-[50vh] max-h-screen text-center border border-black border-dashed rounded-md" style={{borderColor: "#D1D1D6"}}>
